...
python hf_prune.py --pruning_ratio 0.15 \
      ...
      --save_ckpt_log_name /home/bhandk/MLNeuron/result/llama-13b/LLM-pruner/block/original/15 \
...
CUDA_VISIBLE_DEVICES=0,1 python hf_prune.py --pruning_ratio 0.15 \
      ...
      --pruner_type taylor \
      --device cuda   --eval_device cuda \
      --save_distribution_path /home/bhandk/MLNeuron/result/distribution_13b-chat.json \
