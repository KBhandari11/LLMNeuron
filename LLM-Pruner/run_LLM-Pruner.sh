...
CUDA_VISIBLE_DEVICES=0,1 python hf_prune.py --pruning_ratio 0.15 \
      ...
      --pruner_type taylor \
      --device cuda  --eval_device cuda \
      --save_distribution_path /home/bhandk/MLNeuron/result/distribution_7b-chat.json \
      --save_distribution > ./pruner_result/output_block_7b-chat_original.txt 2>&1
'
# Starts with channel
:
CUDA_VISIBLE_DEVICES=0,1 python hf_prune.py --pruning_ratio 0.15 \
      ...
      --device cuda   --eval_device cuda \
      --save_distribution_path /home/bhandk/MLNeuron/result/distribution_7b-chat.json \
      --save_distribution > ./pruner_result/output_channel_7b-chat_original.txt 2>&1
