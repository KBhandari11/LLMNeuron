...
CUDA_VISIBLE_DEVICES=0,1 OMP_NUM_THREADS=12 NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 torchrun --nnodes 1 --nproc_per_node 2 --master_port=25678 hf_prune.py --pruning_ratio 0.15 \
