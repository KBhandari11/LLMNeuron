...
def prune_llama3(logger,dataset_info_list,args): 
    ...
    for dataset_name in dataset_list:
            ...
            model = LlamaForCausalLM.from_pretrained( args.base_model, device_map="auto",torch_dtype=torch.float16)
            ...
            if args.block_wise:
                ...
                for i in range(args.iterative_steps):
                    if pruner_type in ['taylor']:
                        args_dataset = Namespace(save_data = "",do_train_both = False,nsamples=args.num_examples,seqlen=1000,model_type="llama",num_process=10,max_length=0,device='cuda',fine_tune=False,evaluation_size=50, seed=0)
